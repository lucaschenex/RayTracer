...
//	pt_xyz[0] = Vector4f(1,1,1,1.0);
	...
	Sphere test_sphere(ka, test_translate, center, radius*2);
	
    Vector4f center2 = Vector4f(2,2,2,1);
    Sphere test_sphere2(ka, test_translate, center2, radius);
