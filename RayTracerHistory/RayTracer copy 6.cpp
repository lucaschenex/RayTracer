...
//	pt_xyz[0] = Vector4f(1,1,1,1.0);
    ...
    dl_light_counter = 1;
    dl_xyz[0] = Vector4f(0.57735027, -0.57735027, -0.57735027,0);
    dl_rgb[0] = Color(1,1, 1);
    
    // dl_xyz[1] = Vector4f(0.57735027, 0.57735027, -0.57735027,0);
    // dl_rgb[1] = Color(0,0, 1);
	...
	Sphere test_sphere(test_translate, center, radius*3, mtrl);
