...
//      trinomal class and its intersection test haven't been implemented yet.
// 
//  Test:
//      up until scene4 are right
//
    ...
    if(!inpfile.is_open()) {
        ...
        while(inpfile.good()) {
            ...
            //  A translation 3-vector
                ...
                Matrix4f stacktop = tfmStack.get_transformation();
                transformation = stacktop*transformation;
