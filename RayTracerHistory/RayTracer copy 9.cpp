...
//  
//
//  Developed by Ian Y. Chen and Betty Chen at Mar 2013
//
//
//  version Mar7 22:27
...
Color trace(Ray ray,int TraceDepth){
    ...
    hit_index = -1;
    R = R + trace(reflection_ray,TraceDepth-1);
    return R;
};
        ...
        while(inpfile.good()) {
            ...
            //  speciﬁes the camera in the standard way, as in homework 2.
                ...
                // lookat:
                    ...
                    Vector4f camara_looking_point = Vector4f(look_x, look_y, look_z, 1.0f);
                    camara_looking_direction = normalize(camara_looking_point - camara_position);
                // up:
            ...
            //  Deﬁnes a sphere with a given position and radius.
                ...
                Material material = Material(Ambient_input, Diffuse_input, Specular_input, Shiness_input);
